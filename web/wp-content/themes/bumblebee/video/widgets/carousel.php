...
class Video_Carousel_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'playlist_id' ); ?>">Playlist ID:</label>
			<input class="widefat" type="text" id="<?php echo $this->get_field_id( 'playlist_id' ); ?>" name="<?php echo $this->get_field_name( 'playlist_id' ); ?>" value="<?php echo esc_attr( $playlist_id ); ?>" />
		</p>
	...
	public function widget( $args, $instance ) {
		...
		<div class="video-playlist">
			...
			<div class="video-playlist-container">
				<div class="owl-carousel owl-theme" data-playlist="<?php echo $playlist_id; ?>" data-carousel="true">
					<script type="text/x-template">
						<div class="item" data-media-id="%media_id%" data-playlist-id="%playlist_id%" data-playlist-title="<?php echo $title; ?>"><img src="%image%"><h4>%title%</h4>
